...
function CustomTableHeader({
    ...
    return (
        <thead
            ...
            className={cn("bg-muted-light/50 [&_tr]:border-b", className)}
            {...props}
        />
    );
}
...
function CustomTableFooter({
    ...
    return (
        <tfoot
            ...
            className={cn(
                "bg-muted-light/50 border-t font-medium [&>tr]:last:border-b-0",
                className
            )}
            {...props}
        />
...
function CustomTableRow({ className, ...props }: React.ComponentProps<"tr">) {
    return (
        <tr
            data-slot="table-row"
            className={cn(
                "hover:bg-muted-light/40 data-[state=selected]:bg-muted-light/40 border-b transition-colors",
                className
            )}
            {...props}
        />
...
function CustomTableCaption({
    ...
    return (
        <caption
            ...
            className={cn(
                "text-muted-dark my-4 text-sm dark:text-muted-light",
                className
            )}
            {...props}
        />
