...
function CustomDrawerOverlay({
    ...
    return (
        <DrawerPrimitive.Overlay
            ...
            className={cn(
                "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-zinc-950/70 dark:bg-zinc-950/80",
                className
            )}
            {...props}
        />
    ...
    return (
        <CustomDrawerPortal data-slot="drawer-portal">
            ...
            <DrawerPrimitive.Content
                ...
                {...props}
            >
                <div className="bg-muted-dark mx-auto mt-4 hidden h-2 w-30 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block dark:bg-muted-light" />
                {children}
            </DrawerPrimitive.Content>
        </CustomDrawerPortal>
    );
